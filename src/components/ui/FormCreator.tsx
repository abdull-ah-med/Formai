        ...
        return (
                        ...
                        <div className="container mx-auto px-4 py-8">
                                ...
                                {needsGoogleAuth ? (
                                        ...
                                        <div className="max-w-2xl mx-auto flex flex-col h-[calc(100vh-200px)]">
                                                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 mb-4 flex-grow overflow-y-auto">
             ...
             disabled:cursor-not-allowed transition-colors duration-200 shadow-md"
                                                                ...
                                                                <p className="text-xs text-center text-gray-500 mt-2">
                                                                        Formai may produce inaccurate information about
                                                                        forms, people, or facts.
                                                                </p>
                                                        </form>
                                                </div>
                                        </div>
