...
const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({
        ...
        return (
                <Button
                        ...
                        className={cn(
                                "w-full py-3 px-5 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg",
                                "hover:from-blue-700 hover:to-blue-800 transition-all duration-300",
                                "shadow-lg shadow-blue-500/20 flex items-center justify-center gap-3",
                        ...
                        {...rest}
                >
                        <div className="flex items-center justify-center bg-white rounded-full w-6 h-6 shadow-inner">
